	...
	return (
		<div onClick={handleClick} className="RecipeCard__container">
			...
			<div className="RecipeCard__text">
				...
				<p className="RecipeCard__text--details RecipeCard__text--time">
					<span className="text--bold">Time to make: </span>
					{recipe.readyInMinutes} minutes
				</p>
				<p className="RecipeCard__text--details RecipeCard__servings">
					<span className="text--bold">Servings: </span>
					{recipe.servings}
				</p>
				<div className="RecipeCard__text--details RecipeCard__diets">
					{" "}
					{diets}
				</div>
			</div>
			<p
				onClick={toggleLike}
				className={`RecipeCard__heart ${isLiked ? "liked" : null}`}
			>
				<HiHeart />
			</p>
		</div>
